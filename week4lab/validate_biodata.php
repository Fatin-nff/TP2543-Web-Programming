...
if (isset($_POST['biodata_form'])) {
  ...
  {
    $msg .= "Error: Please choose color.<br>";
    $count_error++;
  }
...
<form action="save_biodata.php" method="post">
  <table border="1" cellpadding="10">
    ...
    <tr>
      <td>Sex:</td>
      <td><?php echo titleCase($sex); ?><input type="hidden" name="sex" value="<?php echo $sex; ?>"></td>
    </tr>
    <tr>
      <td>Address:</td>
      <td><?php echo titleCase($address); ?><input type="hidden" name="address" value="<?php echo $address; ?>"></td>
    </tr>
    <tr>
      <td>Email:</td>
