...
<input type="range" name="height" id="heightId" min = "100" max = "200" oninput="outputId.value = heightId.value"  style="width: 25%">
...
<input type="color" name="color" id="idcolor"  style="width: 25%"><br>
...
<input class="button" type="submit" name="biodata_form" value="Submit My Biodata">
